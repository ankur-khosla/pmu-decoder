...
# ABCANCEL
# input_data = ""
...
import ab_translator
ab_translator = ab_translator.ABRaceCancel()

if pMsg.m_iMsgCode == LOGAB_CODE_RAC:
    print(payLoadOutput +ab_translator.packHeader(logAb, pMsg) + ab_translator.translate_abrace(pMsg, logAb))
elif pMsg.m_iMsgCode == LOGAB_CODE_CAN:
    print(payLoadOutput +ab_translator.packHeader(logAb, pMsg) + ab_translator.translate_abcancel(pMsg, logAb))
else:
